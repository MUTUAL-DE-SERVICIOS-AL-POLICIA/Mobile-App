...
import 'package:muserpol_pvt/screens/pages/contributions_pages/card_expanded.dart';
...
class ContributionsYear extends StatelessWidget {
  ...
  Widget card(
      Color colorRefund, BuildContext context, Contribution key, String hero) {
          ...
          Navigator.of(context).push(
            PageRouteBuilder(
              ...
              pageBuilder: (_, __, ___) => CardExpanded(
                  index: hero, contribution: key, colorRefund: colorRefund),
            ),
          );
        },
